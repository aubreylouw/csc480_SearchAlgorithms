...
public class SearchTree_BFS_TEST {
	...
	final SearchFunction SEARCH_ALGO = SearchFunction.BREADTH_FIRST;
	...
	public void testWithEasyInitialState() {
		...
		SearchTree tree = new SearchTree(SEARCH_ALGO, evalFunction, initialState, goalState);
